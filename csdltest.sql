...
insert into Quanlytaikhoan values ('Admin',N'Người quản lý',113,'Nam','admin')
...
insert into Sinhvien values ( 2018603798 , N'Phạm Đức Trung' ,0981953791,'1/1/2000','Nam',N'Hải Dương','KTPM1','A100')
insert into Sinhvien values ( 2018603198 , N'Nguyễn Văn THuần ',0981953791,'2/2/2000','Nam',N'Hải Dương','KTPM2','A101')
insert into Sinhvien values ( 2018603728 , N'Ngô Đình Non' ,0981953791,'3/3/2000','Nam',N'Bắc Giang','OTO1','A102')
...
insert into Lop values ('KTPM1',N'KỸ THUẬT PHẦM MỀM 1','IT2020')
insert into Lop values ('KTPM2',N'KỸ THUẬT PHẦM MỀM 2','IT2020')
insert into Lop values ('TDH1',N'KỸ THUẬT TỰ ĐỘNG HÓA 1','DT2020')
insert into Lop values ('TDH2',N'KỸ THUẬT TỰ ĐỘNG HÓA 2','DT2020')
insert into Lop values ('OTO1',N'KỸ THUẬT Ô TÔ 1','CK2020')
insert into Lop values ('OTO2',N'KỸ THUẬT Ô TÔ 1','CK2020')
...
(
  ...
  Tenkhoa nvarchar(50),
	...
	insert into Khoa values ('IT2020',N'Công nghệ thông tin')
	insert into Khoa values ('DT2020',N'Điện')
	insert into Khoa values ('CK2020',N'Cơ khí')
...
insert into Loaiphong values ('BD1',N'Bình dân', 600000 )
insert into Loaiphong values ('V1',N'Vip', 1000000 )
insert into Loaiphong values ('HS1',N'Hạng sang', 2000000 )

select * from Loaiphong
drop table Loaiphong
-----------------------------------------------------------------------------------------

create view timkiemsv as
