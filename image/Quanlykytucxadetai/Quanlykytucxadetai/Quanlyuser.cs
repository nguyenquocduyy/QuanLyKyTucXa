...
namespace Quanlykytucxadetai
{
    public partial class Quanlyuser : Form
    {
        ...
        private bool ktrauser(string user)
        {
            ...
            ac.connsql.Close();
            if (dt.Rows.Count == 0)
                return true; //chua ton tai user
            else
                return false; //da ton tai user
        }
        private void btnthem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Tài khoản Admin dùng để quản lý người dùng , không thể thêm được ~!");
            }
            else
            {
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ktrauser(txtuser.Text) == false)
                    MessageBox.Show("Tên user không tồn tại", "Thông báo");
                else
                {
                    try
                    {          
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Tài khoản Admin dùng để quản lý người dùng , không thể sửa được ~!");
            }
            else
            {
